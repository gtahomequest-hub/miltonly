...
**Worth raising separately:** the street check *notes* this class ("ISR lag, not a defect"); the hub check *gates* on it. That asymmetry turns routine cache lag into a red run.
