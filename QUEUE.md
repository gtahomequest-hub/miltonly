...
*Addendum 2026-09-15 (MH-007): the detached and semi lease samples mix whole homes, basement units and upper-floors-only leases (detached 308 / 191 / 69 of 568; semi 107 / 19 / 15 of 141; townhouse 605 / 5 / 10 of 620; a condo suite is one unit), so the typical rent for a house type is stated for the whole home with a basement-unit figure beside it where at least five leased, and the blended Milton-wide typical is gone. Head `91f8ef0`, preview `miltonly-hwz0nkjza`, `PASS · 3 checks`. NOT merged; Core merges by SHA.*
