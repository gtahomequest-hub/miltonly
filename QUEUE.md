...
*Out-of-queue work 2026-09-17: MH-008, Aamir's phone review of 2026-09-16, in the `D:\miltonly-home` worktree on `feat/mobile-fixes` from `origin/main@3ad3c0a`: the listing detail page on the forest tokens with the investor block replaced by the k-gated typical rent (whole home and basement unit), the cookie banner as one line in the tokens that pads the body instead of covering the footer, the footer's phone band closed, the street CTA card fitting 390 with the resolved street name in every heading and an honest alert body, the guides block's padding under the theme resets, the compare teaser heading without its em-dash, the sold gate on the site tokens, and `phone-390.mjs`, a 390 gate against clipped text on home, street, hub, listing, rentals and a guide. Previewed at `dd1118f` (`PASS · 6 checks · 589 pages · 599s`), NOT merged; Core merges by SHA. Record in `scratchpad/reports/MH-008-mobile-fixes.md`.*
